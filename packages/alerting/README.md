...
This package is distributed as a ServiceNow update set XML file that can be imported into a customer-managed ServiceNow instance.
...
Import, configuration, and operation instructions are included with the documentation in the current directory.
